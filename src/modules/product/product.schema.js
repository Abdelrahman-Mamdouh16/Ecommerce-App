  ...
  body: joi
    .object({
      ...
      category: joi
        ...
        .custom((value, helpers) => {
          if (isValidObjectId(value) === false) {
            return helpers.message("Product category must be a valid ObjectId");
          }
          return value;
        })
        .required()
        ...
        .custom((value, helpers) => {
          if (isValidObjectId(value) === false) {
            return helpers.message(
              "Product sub-category must be a valid ObjectId",
            );
          }
          return value;
        })
      ...
      brand: joi
        ...
        .custom((value, helpers) => {
          if (isValidObjectId(value) === false) {
            return helpers.message("Product brand must be a valid ObjectId");
          }
          return value;
        })
        .required()
